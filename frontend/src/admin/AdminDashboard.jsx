    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <FaRupeeSign className="text-4xl text-primary opacity-20" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <FaShoppingCart className="text-4xl text-primary opacity-20" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <FaBox className="text-4xl text-primary opacity-20" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <FaUsers className="text-4xl text-primary opacity-20" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link to="/admin/add-product" className="btn-primary text-center">
            Add New Product
          </Link>
